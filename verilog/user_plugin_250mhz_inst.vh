...
//  .NUM_INTF    (NUM_PHYS_FUNC)
  ...
  .s_axis_qdma_h2c_TUSER            (s_axis_qdma_h2c_tuser_size),
  .s_axis_qdma_h2c_TID              (s_axis_qdma_h2c_tuser_src),
  .s_axis_qdma_h2c_TDEST            (s_axis_qdma_h2c_tuser_dst),
  ...
  .m_axis_qdma_c2h_TUSER            (m_axis_qdma_c2h_tuser_size),
  .m_axis_qdma_c2h_TID              (m_axis_qdma_c2h_tuser_src),
  .m_axis_qdma_c2h_TDEST            (m_axis_qdma_c2h_tuser_dst),
  ...
  .m_axis_adap_tx_250mhz_TUSER      (m_axis_adap_tx_250mhz_tuser_size),
  .m_axis_adap_tx_250mhz_TID        (m_axis_adap_tx_250mhz_tuser_src),
  .m_axis_adap_tx_250mhz_TDEST      (m_axis_adap_tx_250mhz_tuser_dst),
  ...
  .s_axis_adap_rx_250mhz_TUSER      (s_axis_adap_rx_250mhz_tuser_size),
  .s_axis_adap_rx_250mhz_TID        (s_axis_adap_rx_250mhz_tuser_src),
  .s_axis_adap_rx_250mhz_TDEST      (s_axis_adap_rx_250mhz_tuser_dst),
